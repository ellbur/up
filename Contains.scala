...
object NotContained
{
	...
	implicit def doesNotContain[H, T <: HList, A](implicit noTail: NotContained[T, A]): NotContained[H :: T, A] = impl
	implicit def ambiguousContains[H, T <: HList, A](implicit contains: A =:= H, noTail: NotContained[T, A]): NotContained[H :: T, A] = impl
